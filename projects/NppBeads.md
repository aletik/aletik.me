...
<div style="text-align: center">
 <download-button href="https://github.com/notepad-plus-plus-mac/NppBeads/releases/download/v0.9/Beadsv0.9.0.dmg" variant="primary" icon="download">Download Beads Viewer DMG (Universal)</download-button>
...
The repo for NppBeads is at [notepad-plus-plus-mac/NppBeads](https://github.com/notepad-plus-plus-mac/NppBeads). The Beads source is at [gastownhall/beads](https://github.com/gastownhall/beads). Both have docs folders that double as feature documentation. 
