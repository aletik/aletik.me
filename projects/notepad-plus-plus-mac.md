...
There are still quite a few quirks to iron out. Panels are still not dockable. There are not as many preferences compared to the Windows version. But there are a few cool things like Shift+Cmd+P which opens spotlight search in Notepad++ macOS version. I also added a few  more languages to Notepad++ localization bringing it up to 137 from 94.   
